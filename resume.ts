...
const addressText = document.getElementById("addressText") as HTMLElement;
addressText.childNodes[1].textContent = myResumeInfoObject.address;

// Personal Information - Birthday
const birthdayText = document.getElementById("birthdayText") as HTMLElement;
birthdayText.childNodes[1].textContent = myResumeInfoObject.birthday;

// TODO: Could be array
// Personal Information - Languages
const languagesText = document.getElementById("languagesText") as HTMLElement;
...
const facultyNameText = document.querySelector("#facultyNameText em") as HTMLElement;
facultyNameText.textContent = myResumeInfoObject.facultyName;

// Education - Faculty Graduation
const graduationText = document.getElementById("graduationText") as HTMLElement;
graduationText.textContent = myResumeInfoObject.graduationYear.toString();
...
// Experience
const companyExperience = document.getElementById("experience")  as HTMLElement;
...
experiencesObjectsArray.forEach((experience) => {
  ...
  workPeriodStartText.textContent = experience.workPeriodStartText.toString();
